...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/quote_list \
  -H 'Content-Type: application/json' \
  -d '{"search":"PETR","limit":10,"sortBy":"name","sortOrder":"asc"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/quote_list`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
